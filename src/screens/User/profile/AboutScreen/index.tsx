      ...
      <YStack padding="$4" gap="$4">
        ...
        <Card bordered padding="$4">
          <YStack gap="$3">
            <H4>About the App</H4>
            <Paragraph>
              Our e-commerce app provides a seamless shopping experience with a
              wide range of products. Browse through categories, find the best
              deals, and enjoy secure checkout with multiple payment options.
            </Paragraph>
            <Paragraph>
              We're committed to providing the best shopping experience with
              fast delivery, easy returns, and excellent customer service.
            </Paragraph>
          </YStack>
        </Card>
          ...
          <YStack gap="$3">
            ...
            <XStack gap="$3" alignItems="center">
              ...
              <YStack>
                ...
                <Text fontSize="$2" color="$gray10">
                  Find products quickly with our advanced search
                </Text>
              </YStack>
            </XStack>
