...
const EditProductScreen = () => {
  ...
  // Hooks
  const {product, isPending: isLoadingProduct} = useGetProductById({productId});
  ...
  if (isLoadingProduct) {
    return (
      <YStack flex={1} justifyContent="center" alignItems="center">
        <Spinner size="large" />
        <Text marginTop="$2">Loading product...</Text>
      </YStack>
    );
  }
            ...
            <Button
              ...
              {isUpdating ? (
                <XStack gap="$2" alignItems="center">
                  ...
                  <Text color="white">Updating Product...</Text>
                </XStack>
              ) : (
                <XStack gap="$2" alignItems="center">
                  <Icon name="save" size={20} color="white" />
                  <Text color="white">Update Product</Text>
                </XStack>
              )}
            </Button>
            {/* Error Display */}
